...
export default function Reglementation() {
  return (
    <div>
      ...
      <ul>
        <li>
          <Link href="/reglementation/terms_of_use">Terms of Use</Link>
        </li>
        <li>
          <Link href="/reglementation/acceptable_use_policy">Acceptable Use Policy</Link>
        </li>
        <li>
          <Link href="/reglementation/cookie_policy">Cookie Policy</Link>
        </li>
        <li>
          <Link href="/reglementation/privacy_policy">Privacy Policy</Link>
        </li>
        <li>
          <Link href="/reglementation/disclaimer">Disclaimer</Link>
        </li>
        <li>
          <Link href="/reglementation/banana_policy">Banana Policy</Link>
        </li>
      </ul>

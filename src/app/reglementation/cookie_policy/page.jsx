          ...
          <strong>
            <span style={{ fontSize: '15px' }}>
              <span data-custom-class="subtitle">
                Last updated <bdt class="question">July 29, 2023</bdt>
              </span>
            </span>
          </strong>
        </span>
        ...
        <span style={{}}>
          <span style={{ fontSize: '15px' }}>
            <span data-custom-class="body_text">
              This Cookie Policy explains how <bdt class="question">AE PIMA</bdt> (
              <strong>"we"</strong>," "<strong>us</strong>," and "<strong>our</strong>") uses
          ...
          <span style={{ fontSize: '15px' }}>
            <span data-custom-class="body_text">
              <bdt class="question">
                <a
                  href="https://pima.ozieblowski.dev"
                  target="_blank"
                  data-custom-class="link"
                >
                  https://pima.ozieblowski.dev
                </a>
              </bdt>
            </span>
          </span>
          <span style={{ fontSize: '15px' }}>
            <span data-custom-class="body_text">
              {' '}
              ("<strong>Website</strong>"). It explains what these technologies are and why we use
        ...
        <span style={{}}>
          <span style={{ fontSize: '15px' }}>
            <span data-custom-class="body_text">
              ...
              <bdt class="question">Kacper Ozieblowski</bdt>) are called "first-party cookies."
        ...
        <span style={{}}>
          <span style={{ fontSize: '15px' }}>
            <span data-custom-class="body_text">
              ...
              <bdt class="statement-end-if-in-editor"></bdt>party cookies for several reasons.
              Some cookies are required for technical reasons in order for our Website to
              ...
              <bdt class="block-component"></bdt>Third parties serve cookies through our Website
      ...
      <div style={{ lineHeight: '1.5' }}>
        <span style={{}}>
          <span style={{ fontSize: '15px' }}>
            ...
            <span style={{ fontSize: '15px' }}>
              <span data-custom-class="body_text">
                to recognize or track visitors to a website. We may use other, similar
                ...
                identifier that enables us to recognize when someone has visited our Website
                <bdt class="block-component"></bdt> or opened an email including them
                <bdt class="statement-end-if-in-editor"></bdt>. This allows us, for example, to
                monitor&nbsp;
              </span>
              <span style={{ fontSize: '15px' }}>
                <span style={{}}>
                  <span data-custom-class="body_text">
                    the traffic patterns of users from one page within a website to another, to
      ...
      <div style={{ lineHeight: '1.5' }}>
        <span style={{ fontSize: '15px' }}>
          <span data-custom-class="body_text">
            ...
            services of potential interest to you. The information collected through this process
            does not enable us or them to identify your name, contact details, or other details
      ...
      <div style={{ lineHeight: '1.5' }}>
        <span style={{ fontSize: '15px' }}>
          <span style={{ fontSize: '15px' }}>
            ...
            <span style={{ fontSize: '15px' }}>
              <span data-custom-class="body_text">
                this Cookie Policy from time to time in order to reflect, for example, changes
                to the cookies we use or for other operational, legal, or regulatory reasons.
                Please therefore revisit this Cookie Policy regularly to stay informed about our
          ...
          <span style={{ fontSize: '15px' }}>
            <span style={{ fontSize: '15px' }}>
              <span data-custom-class="body_text">
                ...
                email us at <bdt class="question">pima@ozieblowski.dev</bdt>.
                <bdt class="block-component"></bdt>
                <bdt class="block-component"></bdt>
        ...
        <span data-custom-class="body_text">
          <span style={{ fontSize: '15px' }}>
            <bdt class="statement-end-if-in-editor">
              Phone: <bdt class="question">+33647780591</bdt>
            </bdt>
          </span>
        </span>
        <span data-custom-class="body_text">
